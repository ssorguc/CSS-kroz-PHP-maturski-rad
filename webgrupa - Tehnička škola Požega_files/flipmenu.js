...
// ## Images to use (specify full path)
	flipImg_open   = "interface/flip_open.gif";
	flipImg_closed = "interface/flip_closed.gif";
	flipImg_static = "interface/flip_static.gif";
...
document.write(
	...
	"ul.flipMenu { margin-top: " + flipTopMargin + "; " + (flipImages ? "" : "list-style-type: none;") + " }" +
	"ul.flipMenu ul, ul.flipMenu li { padding-top: " + flipVerticalPadding + "; margin_right: 0px; " + (flipImages ? "" : "list-style-type: none;") + " }" +
